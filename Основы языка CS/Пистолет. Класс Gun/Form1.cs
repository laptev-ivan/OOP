...
namespace Пистолет.Класс_Gun
{
    public class Gun {
        ...
        public int V0 {
            set {
                if (value > 0) v0 = value;
                else throw new Exception(@"скорость не может быть меньше нуля.");
            }
        }
        ...
        public int Alpha {
            set {
                ...
                else throw new Exception(@"угол не может быть меньше нуля или больше 90 градусов.");
            }
        }
        ...
        public int H {
            set {
                ...
                else throw new Exception(@"высота не может быть меньше нуля.");
            }
        }
